...
const SupervisorLayout = () => {
  ...
  const navLinks = [
    { name: 'Dashboard', to: '/supervisor/dashboard', icon: HomeIcon },
    { name: 'Pending Assignments', to: '/supervisor/pending-assignments', icon: ClipboardDocumentListIcon },
    { name: 'Writer Management', to: '/supervisor/writers', icon: UsersIcon },
    { name: 'Feedback Management', to: '/supervisor/feedback', icon: StarIcon },
    { name: 'Payout Management', to: '/supervisor/payouts', icon: BanknotesIcon },
  ];
  ...
  const getPageTitle = () => {
    ...
    if (path === '/supervisor/pending-assignments') return 'Pending Assignments';
    if (path === '/supervisor/writers') return 'Writer Management';
    if (path === '/supervisor/feedback') return 'Feedback Management';
    if (path === '/supervisor/payouts') return 'Payout Management';
        ...
        <header className="bg-white shadow-sm border-b border-neutral-200 sticky top-0 z-10">
          <div className="h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center space-x-4">
              <button 
                type="button"
                className="relative p-1 rounded-full bg-white text-neutral-600 hover:text-neutral-900 focus:outline-none focus:ring-2 focus:ring-accent-500"
              >
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0 h-8 w-8 rounded-full bg-accent-700 flex items-center justify-center text-white font-medium">
