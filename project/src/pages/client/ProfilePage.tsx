        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-neutral-500">Receive updates about your resume requests</p>
            </div>
            <div className="relative inline-block w-12 h-6 transition duration-200 ease-in-out rounded-full cursor-pointer bg-primary-600">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-neutral-500">Receive offers and promotional messages</p>
            </div>
            <div className="relative inline-block w-12 h-6 transition duration-200 ease-in-out rounded-full cursor-pointer bg-neutral-300">
